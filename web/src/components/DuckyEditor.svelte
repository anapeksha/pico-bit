...
<section class:flex-1={$activeAccordion === 'ducky'} class="flex min-h-0 shrink-0 flex-col">
  ...
  {#if $activeAccordion === 'ducky'}
    <div class="flex min-h-0 flex-1 flex-col">
      ...
      <div class="grid min-h-112 grid-cols-[3rem_minmax(0,1fr)]">
        <div
        ...
        <div class="relative overflow-hidden bg-(--surface)">
          ...
          <textarea
            ...
            bind:value={$payload}
            id="payload"
            class="relative z-10 block h-full min-h-112 w-full resize-none overflow-auto whitespace-pre border-0 bg-transparent p-[0.85rem_1rem] font-mono text-[13px] leading-[1.7] text-transparent caret-(--text) outline-none tab-4"
            spellcheck="false"
            autocapitalize="off"
            autocomplete="off"
