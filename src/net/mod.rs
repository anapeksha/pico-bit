...
pub(crate) use http::{
    ...
    host_hid_active, ncm_active, ncm_url, record_payload_run, runs_snapshot, save_payload_code,
    seeded_this_boot, set_host_hid_active, set_ncm_active, trigger_payload_run,
